...
class Family(family.Family):          # REQUIRED
    def __init__(self):               # REQUIRED
        ...
        self.name = 'metaphor'        # REQUIRED; replace with actual name

        self.langs = {                # REQUIRED
            'en': 'metaphor.icsi.berkeley.edu/test',  # Include one line for each wiki in family
        ...
        self.namespaces[4] = {
            '_default': [u'MetaNet Project Test', self.namespaces[4]['_default']], 
        }
        self.namespaces[5] = {
            '_default': [u'MetaNet Project Test talk', self.namespaces[5]['_default']], 
        }
        self.namespaces[552] = { 'en': 'Schema' }
        self.namespaces[556] = { 'en': 'AutoSchema' }
        self.namespaces[102] = { 'en': 'Property' }
        self.namespaces[103] = { 'en': 'Property talk' }
        self.namespaces[106] = { 'en': 'Form' }
        self.namespaces[107] = { 'en': 'Form talk' }
        self.namespaces[108] = { 'en': 'Concept' }
        self.namespaces[109] = { 'en': 'Concept talk' }
        self.namespaces[274] = { 'en': 'Widget' }
        self.namespaces[275] = { 'en': 'Widget talk' }
        self.namespaces[500] = { 'en': 'Event' }
        self.namespaces[501] = { 'en': 'Event talk' }
        self.namespaces[502] = { 'en': 'Glossary' }
        self.namespaces[503] = { 'en': 'Glossary talk' }
        self.namespaces[550] = { 'en': 'Metaphor' }
        self.namespaces[551] = { 'en': 'Metaphor talk' }
        self.namespaces[553] = { 'en': 'Schema talk' }
        self.namespaces[554] = { 'en': 'AutoMetaphor' }
        self.namespaces[555] = { 'en': 'AutoMetaphor talk' }
        self.namespaces[557] = { 'en': 'AutoSchema talk' }
        self.namespaces[800] = { 'en': 'Cit' }
        self.namespaces[801] = { 'en': 'Cit talk' }
